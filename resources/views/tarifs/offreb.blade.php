...
<head>
    ...
    <title>Offres Pro (Type 2) | ProLocAuto</title>
...
<body>
    ...
    <div class="container">
        <div class="text-center mb-5">
            <h1 class="display-5 fw-bold">Nos Bureaux "Pro"</h1>
            <p class="lead text-muted">Des bureaux fermés pour plus de confidentialité (Type 2)</p>
        </div>
                    ...
                    <div class="card card-annonce h-100 shadow-sm border-0">
                        ...
                        <div class="card-body d-flex flex-column text-center">
                            ...
                            <div class="mt-auto w-100">
                                <!-- Le lien de réservation (Même logique que Offre A) -->
                                <a href="{{ route('client.reservation.form', $annonce->id) }}" class="btn w-100 btn-lg btn-outline-success">
                                    Réserver ce bureau
                                </a>
                            </div>
                        </div>
            ...
            @empty
                <div class="col-12 text-center">
                    <div class="alert alert-info py-5">
                        ...
                        <p>Tous nos bureaux sont actuellement réservés ou indisponibles.</p>
                    </div>
                </div>
            @endforelse
        </div>
